        ...
        <div className="space-y-8 text-stone-600 text-[15px] leading-relaxed">
          ...
          <Section title="Token encryption in transit">
            <p>
              ...
              This transit key is separate from the at-rest key. Even if one were compromised,
              the other stays secure.
            </p>
            <p className="mt-2">
          ...
          <Section title="Key isolation">
            <p>
              Our infrastructure uses three independent secrets, each scoped to a
              single function and deployed only to the services that need it:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong>At-rest key</strong> encrypts stored tokens. Only the scheduling service has access.</li>
              <li><strong>Transit key</strong> encrypts tokens in flight between services. Never used for storage.</li>
              <li><strong>Signing key</strong> authenticates requests between services. Can't decrypt anything.</li>
            </ul>
            <p className="mt-2">
              Compromising one key is not enough to read a token or forge a request.
              An attacker would need access to multiple isolated systems at once.
            </p>
          </Section>
          ...
          <Section title="Per-user isolation (Durable Objects)">
            <p>
              ...
              isolated, single-threaded compute instance with its own storage:
            </p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              ...
              <li><strong>Fault isolation.</strong> An issue with one user's DO can't affect another user's data or scheduling.</li>
          ...
          <Section title="Connect flow security">
            ...
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li><strong>Unguessable session ID</strong> using a cryptographically random UUID.</li>
              <li><strong>5-minute TTL.</strong> Sessions expire quickly and can't be reused.</li>
          ...
          <Section title="Questions?">
            <p>
              ...
              email <a href="mailto:sam.mcdonald.dev@gmail.com" className="text-emerald-600 underline">sam.mcdonald.dev@gmail.com</a>.
            </p>
          </Section>
        </div>
      </main>
